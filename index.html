...
<body>
  ...
  <!-- Shade Input Form -->
  <label for="incisal">Incisal Shade:
    <input type="text" id="incisal">
  </label><br>
  <label for="body">Body/Mid Shade:
    <input type="text" id="body">
  </label><br>
  <label for="gingival">Gingival Shade:
    <input type="text" id="gingival">
  </label><br>
  <button onclick="displayShade()">Submit</button>

  <!-- Output Section -->
  <p>Converted Shades:</p>
  <p>Incisal: <span id="incisalOutput"></span></p>
  <p>Body: <span id="bodyOutput"></span></p>
  <p>Gingival: <span id="gingivalOutput"></span></p>
  ...
  <script>
    ...
    function displayShade() {
      ...
      // Smart fallback: incisal -> body -> gingival -> none
      let fallback = incisalConverted || bodyConverted || gingivalConverted || "No shade entered";
      ...
      // document.getElementById("summaryOutput").innerText = fallback;
    }
  </script>
